...
> รูปนี้เป็นตัวอย่างเล็กที่สุด — comment บรรทัดเดียวได้โค้ดบรรทัดเดียว
> แบบฝึกหัดใน `exercises.js` ใหญ่กว่านั้น คือ comment หนึ่งย่อหน้าได้ทั้งฟังก์ชัน กลไกเดียวกัน คนละขนาด

1. เขียน comment อธิบายสิ่งที่ต้องการให้ฟังก์ชันทำ
2. กด Enter ขึ้นบรรทัดใหม่ แล้วรอ ghost text สีเทาโผล่มาเอง
3. `Tab` รับ · `Esc` ปัด · `Alt` + `]` ดูตัวเลือกอื่น
4. ปรับแต่งโค้ดที่ได้ตามต้องการ
